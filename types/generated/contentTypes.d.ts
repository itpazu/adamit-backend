...
export interface ApiCallForActionCallForAction extends Schema.SingleType {
  collectionName: 'call_for_actions';
  info: {
    singularName: 'call-for-action';
    pluralName: 'call-for-actions';
    displayName: 'CallForAction';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    contactForm: Attribute.Component<'views.contact-form'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    createdBy: Attribute.Relation<
      'api::call-for-action.call-for-action',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiContactContact extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contactChannels: Attribute.DynamicZone<['views.email', 'views.phone']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiDonatePageDonatePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    helpItems: Attribute.Component<'views.help-item', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiFlagFlag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::flag.flag', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::flag.flag', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    bodyTexts: Attribute.Component<'views.text-box', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::call-for-action.call-for-action': ApiCallForActionCallForAction;
